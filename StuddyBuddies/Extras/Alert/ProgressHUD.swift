...
public extension ProgressHUD {
    ...
    // MARK: -
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func show(_ status: String? = nil, icon: AlertIcon, interaction: Bool = false) {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func show(_ status: String? = nil, icon animatedIcon: AnimatedIcon, interaction: Bool = false) {
    ...
    // MARK: -
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func showSuccess(_ status: String? = nil, image: UIImage? = nil, interaction: Bool = false) {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func showError(_ status: String? = nil, image: UIImage? = nil, interaction: Bool = false) {
    ...
    // MARK: -
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func showSucceed(_ status: String? = nil, interaction: Bool = false) {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func showFailed(_ status: String? = nil, interaction: Bool = false) {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func showAdded(_ status: String? = nil, interaction: Bool = false) {
...
public class ProgressHUD: UIView {
    ...
    private var animationType    = AnimationType.circleStrokeSpin

    private var colorBackground    = UIColor(red: 0, green: 0, blue: 0, alpha: 0.4)
    private var colorHUD        = UIColor.clear
    private var colorStatus        = UIColor.label
    private var colorAnimation    = UIColor(.black)
